...
import { Bolt, CircleDollarSignIcon, Gavel, StoreIcon } from 'lucide-react';
...
const WrappedStoreIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
