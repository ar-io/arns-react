...
function SettingsLayout() {
  ...
  return (
    <div className="flex flex-col w-full h-fit min-h-screen min-h-full box-border">
      <div className="bg-foreground">
        <NavBar />
      </div>
      <div className="flex flex-col w-full h-full px-[100px] py-[30px]">
        <div
          className="flex w-full h-full rounded-xl rounded-t-none border-dark-grey border-[1px]"
          style={{ gap: 0 }}
        >
          <div className="flex flex-col w-1/4 text-white max-w-[300px] border-r-[1px] border-dark-grey rounded-bl-xl">
