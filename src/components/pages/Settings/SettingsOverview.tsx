  ...
  return (
    <div className="flex flex-col w-full h-full p-3">
      <div className="flex flex-col w-full h-full bg-background gap-5 p-2 rounded-xl border border-dark-grey">
        <Link
          className="flex flex-row justify-between p-4 bg-metallic-grey hover:bg-primary-thin border border-primary-thin text-primary rounded-md text-lg font-semibold"
          to={'/settings/arns'}
        >
