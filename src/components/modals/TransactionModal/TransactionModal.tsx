...
function TransactionModal({
  ...
  return (
    <div className="page" style={isMobile ? { padding: 'none' } : {}}>
      {/**modal header */}
      <div
      ...
      >
        ...
        >
          ...
          <button className="modal-close-button" onClick={() => showModal()}>
            <CloseIcon width="20px" height={'20px'} fill="var(--text-white)" />
          </button>
        </div>
          ...
          >
            ...
            {getAssociatedNames(contractId!).length ? (
              ...
              >
                ...
                >
                  This ANT has{' '}
                  {`${getAssociatedNames(contractId!).length} name(s)`} that are
                  associated with it. By transferring this ANT, you will also be
